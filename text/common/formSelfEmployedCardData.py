...
class FormSelfEmployedCardData:
    ...
    async def _unpack(self):
        ...
        self.__card_number = self.__data.get("cardNumber", "...")
        self.__card_date = self.__data.get("cardDate", "...")
    ...
    async def menu_personal_data(self):
        ...
        text = text.substitute(account=self.__Lang.personalData.common.account, account_user=self.__email,
                               ...
                               fio=self.__Lang.personalData.common.fioCard, fio_user=self.__fio_user,
