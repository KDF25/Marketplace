...
class FirstSelfEmployedCardAdvertiser(StatesGroup):
    ...
    async def _check_data(self, call, data):
        ...
        if len(data.get("selfEmployedCard")) != 10:
    ...
    def register_handlers(self, dp: Dispatcher):
        dp.register_callback_query_handler(self.menu_first_data, text="selfEmployedCard",                               state="RegistrationAdvertiser:regAdvertiser_level6")
        ...
        dp.register_callback_query_handler(self.menu_card_number, text="cardNumber",                                    state=self.firstData_level2)
        dp.register_callback_query_handler(self.menu_card_date, text="cardDate",                                        state=self.firstData_level2)
