...
class PersonalDataSelfEmployedAccountAdvertiser(StatesGroup):
    ...
    def register_handlers(self, dp: Dispatcher):
        dp.register_callback_query_handler(self.menu_personal_data, text="selfEmployedAccount",                         state="PersonalDataSelfEmployedAccountAdvertiser:personalData_level1")
