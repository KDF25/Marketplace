...
class PersonalDataEntityAdvertiser(StatesGroup):
    ...
    def register_handlers(self, dp: Dispatcher):
        dp.register_callback_query_handler(self.menu_personal_data, text="entity",                                      state="PersonalDataEntityAdvertiser:personalData_level1")
        ...
        dp.register_callback_query_handler(self.menu_inn, text="inn",                                                   state=self.personalData_level2)
