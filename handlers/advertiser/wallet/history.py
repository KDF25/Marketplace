...
class HistoryWalletAdvertiser(StatesGroup):
    ...
    def register_handlers(self, dp: Dispatcher):
        dp.register_callback_query_handler(self.menu_history, text="history",                                           state=["WalletAdvertiser:walletAdvertiser_level1", "*"])
        dp.register_callback_query_handler(self.menu_more_history, text="moreHistory",                                  state=["WalletAdvertiser:walletAdvertiser_level1", "*"])
