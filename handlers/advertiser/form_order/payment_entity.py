...
class FormOrderPaymentEntity(StatesGroup):
    ...
    async def _payment_didox(data):
        json = WalletModel(type_legal="entity", amount=int(data.get("formOrder").get("basket").get("total_cost") - data.get("formOrder").get("wallet")))
    ...
    def register_handlers(self, dp: Dispatcher):
        dp.register_callback_query_handler(self.menu_personal_data, text="entity",                                      state="FormOrderWallet:walletFormOrder_level2")
