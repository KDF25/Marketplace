...
class AddDataSelfEmployedCardBlogger(StatesGroup):
    ...
    def register_handlers(self, dp: Dispatcher):
        dp.register_callback_query_handler(self.menu_add_data, text="selfEmployedCard",                                 state="PersonalDataBlogger:personalDataBlogger_level2")
