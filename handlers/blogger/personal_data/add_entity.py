...
class AddDataEntityBlogger(StatesGroup):
    ...
    def register_handlers_personal(self, dp: Dispatcher):
        dp.register_callback_query_handler(self.menu_add_data, text="entity",                                           state="PersonalDataBlogger:personalDataBlogger_level2")
