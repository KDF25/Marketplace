...
class AddDataIndividualBlogger(StatesGroup):
    ...
    def register_handlers_personal(self, dp: Dispatcher):
        dp.register_callback_query_handler(self.menu_add_data, text="individual",                                       state="PersonalDataBlogger:personalDataBlogger_level2")
