...
class PaymentCommonBlogger(StatesGroup):
    ...
    async def _success(call: types.CallbackQuery, form):
        ...
        # await bot.send_message(chat_id=self.__call.from_user.id, text=self.__Lang.wallet.end,
        #                        reply_markup=await self.__reply.menu_blogger())
    ...
    def register_handlers(self, dp: Dispatcher):
        dp.register_callback_query_handler(self.menu_cash, text="balance",                                              state="WalletBlogger:walletBlogger_level1")
        ...
        dp.register_callback_query_handler(self.menu_employment, text="back",                                           state=[self.paymentCommon_level3,
                                                                                                                               "PaymentEntityBlogger:payment_level1",
                                                                                                                               "PaymentIndividualBlogger:payment_level1"
                                                                                                                               ])
        ...
        dp.register_callback_query_handler(self.menu_self_employed, text="back",                                        state=[self.paymentCommon_level4,
                                                                                                                               "PaymentSelfEmployedAccountBlogger:payment_level1"])
