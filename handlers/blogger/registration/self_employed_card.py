...
class FirstSelfEmployedCardBlogger(StatesGroup):
    ...
    def register_handlers(self, dp: Dispatcher):
        dp.register_callback_query_handler(self.menu_first_data, text="selfEmployedCard",                               state="FirstPlatformBlogger:firstPlatform_level15")
